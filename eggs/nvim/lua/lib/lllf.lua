...
local function close(file)
  ...
  return sprintf("Failed to close lsp list file located at %s with exitcode %s: %d", lllf.path, exitcode, code)
end
...
function lllf.register(name)
  ...
  if registered then
    return sprintf("%s already registered", name)
  end
...
function lllf.unregister(name)
  ...
  if not registered then
    return sprintf("%s not registered", name)
  end
